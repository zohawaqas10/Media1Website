...
owl.owlCarousel({
    navigation: true, // ✅ turn on arrows
    navigationText: [
        '<i class="lni-chevron-left"></i>', // left arrow icon
        '<i class="lni-chevron-right"></i>' // right arrow icon
    ],
    pagination: true, // keep dots if you want
    slideSpeed: 1000,
    margin: 10,
    stopOnHover: true,
    autoPlay: true,
